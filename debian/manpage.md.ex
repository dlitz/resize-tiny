% resize-tiny(SECTION) | User Commands
%
% "July  5 2023"
...
resize-tiny - program to do something

# SYNOPSIS

**resize-tiny** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**resize-tiny** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **resize-tiny** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**resize-tiny** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    resize-tiny. See **foo.conf**(5) for further details.
...
**resize-tiny** provides some return codes, that can be used in scripts:
